...
using WebApiModelo.data.Repositories;
using WebApiModelo.domain.Interfaces;

namespace WebApiModelo.api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<ToJobContext, ToJobContext>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Modelo API V1");
            });
